  ...
  return (
    <Section id="contact" className="relative py-20">
      <SectionHeading
        ...
        bgImage="/src/assets/banner/Banner4.jpg"
      />
        ...
        <div className="backdrop-blur-md rounded-2xl p-8 shadow-lg relative overflow-hidden bg-[radial-gradient(circle_at_top_left,var(--color-primary)_0%,var(--color-text)_90%,var(--color-text)_100%)]">
          ...
          {!sent && !loading ? (
            ...
            >
              ...
              <button
                type="submit"
                className="flex items-center gap-2 justify-center w-full bg-[--color-primary] text-[--color-bg] font-semibold py-3 rounded-full hover:opacity-90 transition-all shadow-lg"
              >
            ...
            <div className="text-center space-y-3 relative z-10">
              ...
              <p className="text-[--color-bg] text-sm">
                Our team will review your query and contact you back shortly.
              </p>
              <button
                onClick={() => setSent(false)}
                className="mt-4 text-sm text-[--color-bg] underline hover:opacity-80"
              >
