    ...
    return (
        <Section>
            <div className="relative overflow-hidden py-12 bg-[radial-gradient(circle_at_top_left,var(--color-primary)_0%,var(--color-text)_90%,var(--color-text)_100%)]">
                <h2 className="text-center text-2xl md:text-3xl font-semibold text-[var(--color-bg)]">
                    Our Clients
                </h2>

                <TextCard className="text-[var(--color-bg)]" text="At first, Second Nature Oils was available solely through distributors. Our products are now stocked in various Irish health food retailers, Organic Shops and distributors.
