                                    ...
                                    >
                                        ...
                                        <div className="flex items-center gap-4 mt-6">
                                            ...
                                            <button
                                                ...
                                                className={`flex items-center justify-center gap-2 px-6 py-3 rounded-xl border transition flex-1
                                                    ${paymentMethod === "card"
                                                        ? "border-[var(--color-accent)] bg-white shadow"
                                                        : "border-gray-300 bg-gray-50"}`}
                                            >
                                                <span className="text-2xl">💳</span>
                                                <span className="font-medium  text-xs text-[var(--color-accent)]">Card Payment</span>
                                                {paymentMethod === "card" && <span className="text-green-600 text-xl">✔</span>}
                                            </button>
                                            ...
                                            >
                                                <span className="text-2xl">🚚</span>
                                                <span className="font-medium text-xs text-[var(--color-accent)]">Cash on Delivery</span>
                                                {paymentMethod === "cod" && <span className="text-green-600 text-xl">✔</span>}
                                            </button>
