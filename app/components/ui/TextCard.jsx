        ...
        <div className={`backdrop-blur-sm rounded-2xl p-4 transition-shadow animate-fadeIn justify-self-center ${className} text-center mb-4`}>
            <FadeInView>
                <div className="relative flex flex-col items-center">
                    {icon ? <div className="p-3 bg-gradient-to-br from-[var(--color-primary)] to-[var(--color-accent)] rounded-full shadow-lg mb-8">
                        <Icon className="w-8 h-8 text-[var(--color-bg)]" />
                    </div> : null}
