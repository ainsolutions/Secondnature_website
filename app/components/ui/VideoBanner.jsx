    ...
    return (
        <section className="relative h-[100vh] w-full overflow-hidden flex items-center justify-center">
            ...
            <div className="relative z-10 text-center px-4">
                <p className="mt-4 text-lg md:text-xl text-[var(--color-bg)] animate-fadeIn delay-200">
                    Fresh & Natural
                </p>

                <h1 className="text-5xl md:text-6xl font-bold text-[var(--color-bg)] drop-shadow-lg animate-fadeIn">
                    Second Nature Oils
                </h1>
                <p className="mt-4 text-lg md:text-xl text-[var(--color-bg)] animate-fadeIn delay-200">
                    Be Friendly
                ...
                <a href="#about">
                    <button
                        className="mt-8 px-8 py-3 bg-[var(--color-primary)] text-[var(--color-bg)] rounded-full font-semibold hover:bg-[var(--color-accent)]/90 transition duration-300 animate-fadeIn delay-500">
                        Explore More
                    </button>
                </a>
            </div>
