              ...
              >
                {isAbove && (
                  <div className="mb-3">
                    ...
                    <h3 className="text-sm md:text-base font-semibold text-[var(--color-primary)]">
                      {item.title}
                    </h3>
                    <p className="text-[11px] text-[var(--color-text)]">{item.desc}</p>
                  </div>
                )}

                <div className="relative flex flex-col items-center">
                  <div className="p-3 bg-gradient-to-br from-[var(--color-primary)] to-[var(--color-accent)] rounded-full shadow-lg border-2 border-[var(--color-primary)]">
        ...
        <div className="flex flex-col md:hidden mt-10 space-y-6">
          {timelineData.map((item, index) => {
            ...
            return (
              ...
              >
                <div className="p-2 bg-gradient-to-br from-[var(--color-primary)] to-[var(--color-accent)] rounded-full shadow-md border border-[var(--color-primary)] mt-1">
                  <Icon className="w-4 h-4 text-white" />
                </div>
                <div>
                  <p className="text-xs text-[--color-text]">{item.year}</p>
